...
class PlanningGraph():
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return (len(list(set(node_a1.action.effect_add) & set(node_a2.action.precond_neg))) > 0 or
                len(list(set(node_a2.action.effect_add) & set(node_a1.action.precond_neg))) > 0 or
                len(list(set(node_a1.action.effect_rem) & set(node_a2.action.precond_pos))) > 0 or
                len(list(set(node_a2.action.effect_rem) & set(node_a1.action.precond_pos))) > 0)
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for action_1 in node_a1.parents:
            for action_2 in node_a2.parents:
                if action_1.is_mutex(action_2):
                    return True
        return False
